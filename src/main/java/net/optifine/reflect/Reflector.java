...
public class Reflector
{
    ...
    public static ReflectorMethod ForgeHooksClient_renderMainMenu = new ReflectorMethod(ForgeHooksClient, "renderMainMenu", new Class[] {MenuScreen.class, MatrixStack.class, FontRenderer.class, Integer.TYPE, Integer.TYPE, Integer.TYPE});
    ...
    public static ReflectorMethod NotificationModUpdateScreen_init = new ReflectorMethod(NotificationModUpdateScreen, "init", new Class[] {MenuScreen.class, Button.class});
    ...
    public static ReflectorClass GuiMainMenu = new ReflectorClass(MenuScreen.class);
