...
import ru.levelup.client.api.event.impl.EventWorldRenderer;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof MenuScreen)
        {
            this.updateMainMenu((MenuScreen) this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(MenuScreen p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
