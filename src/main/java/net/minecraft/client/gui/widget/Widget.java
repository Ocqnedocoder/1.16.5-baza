...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener
{
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        DrawHelper.drawRound(x, y + 2, width, height - 2, 2, ColorUtil.getColor(25, 255));
        Fonts.font20.drawCenteredString(matrixStack, this.getMessage().getString(), this.x + this.width / 2,
                this.y + (this.height - 13) / 2, j | MathHelper.ceil(this.alpha * 255.0F) << 24);
